...
import { MetadataAutoSerializer } from '../serialization';
import { SerializedEvent } from '../serializedEvent';
import { Event } from '../event/Event';
import { CreationEvent, TransformationEvent } from '../event';
import { Aggregate } from '../aggregate';
import { PostgresConnectionPool, log } from '../util';
...
export class PostgresTransactionalEventStore {
  ...
  constructor(
    ...
    @inject(MetadataAutoSerializer)
    private readonly serializer: MetadataAutoSerializer,
  ...
  async findAggregate<T extends Aggregate>(
    ...
    const events = serializedEvents.map((e) => this.serializer.deserialize(e));
