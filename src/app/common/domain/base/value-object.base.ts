...
export abstract class ValueObject<T, R = T> {
  ...
  unpack(): R {
    if (this.isDomainPrimitive(this.props)) {
      return this.props.value as R;
    }

    const propsCopy = convertPropsToObject(this.props) as R;
  ...
  private checkIfEmpty(props: ValueObjectProps<T>): void {
    if (
      ...
      throw new PreconditionFailedError('Property cannot be empty');
    }
  }
